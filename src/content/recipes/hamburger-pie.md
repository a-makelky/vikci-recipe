...
scan_assets:
  - path: /scans/hamburger-pie/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/hamburger-pie/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/hamburger-pie/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/hamburger-pie/back-original.jpg
    label: Back scan
    type: image
    role: original
---
