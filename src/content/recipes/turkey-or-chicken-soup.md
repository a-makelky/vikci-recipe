---
id: scan-only-turkey-or-chicken-soup
...
scan_assets:
  - path: /scans/turkey-or-chicken-soup/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/turkey-or-chicken-soup/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/turkey-or-chicken-soup/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/turkey-or-chicken-soup/back-original.jpg
    label: Back scan
    type: image
    role: original
---
