---
id: scan-only-cabbage-bundles
title: Cabbage Bundles
...
scan_assets:
  - path: /scans/cabbage-bundles/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/cabbage-bundles/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/cabbage-bundles/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/cabbage-bundles/back-original.jpg
    label: Back scan
    type: image
    role: original
---
