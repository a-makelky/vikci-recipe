...
scan_assets:
  - path: /scans/vegetable-pizza/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/vegetable-pizza/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/vegetable-pizza/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/vegetable-pizza/back-original.jpg
    label: Back scan
    type: image
    role: original
---
