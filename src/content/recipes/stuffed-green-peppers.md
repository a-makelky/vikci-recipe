---
id: scan-only-stuffed-green-peppers
...
scan_assets:
  - path: /scans/stuffed-green-peppers/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/stuffed-green-peppers/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/stuffed-green-peppers/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/stuffed-green-peppers/back-original.jpg
    label: Back scan
    type: image
    role: original
---
