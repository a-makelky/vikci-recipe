...
scan_assets:
  - path: /scans/potato-soup-2/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/potato-soup-2/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/potato-soup-2/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/potato-soup-2/back-original.jpg
    label: Back scan
    type: image
    role: original
---
