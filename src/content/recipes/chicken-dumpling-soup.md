---
id: scan-only-chicken-dumpling-soup
...
scan_assets:
  - path: /scans/chicken-dumpling-soup/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/chicken-dumpling-soup/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/chicken-dumpling-soup/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/chicken-dumpling-soup/back-original.jpg
    label: Back scan
    type: image
    role: original
---
