---
id: scan-only-chopped-suey-casserole
title: Chopped Suey Casserole
...
scan_assets:
  - path: /scans/chopped-suey-casserole/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/chopped-suey-casserole/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/chopped-suey-casserole/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/chopped-suey-casserole/back-original.jpg
    label: Back scan
    type: image
    role: original
---
