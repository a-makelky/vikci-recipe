...
scan_assets:
  - path: /scans/enchilada/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/enchilada/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/enchilada/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/enchilada/back-original.jpg
    label: Back scan
    type: image
    role: original
---
