---
id: scan-only-potato-puff-casserole
...
scan_assets:
  - path: /scans/potato-puff-casserole/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/potato-puff-casserole/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/potato-puff-casserole/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/potato-puff-casserole/back-original.jpg
    label: Back scan
    type: image
    role: original
---
