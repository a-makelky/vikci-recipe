---
id: scan-only-cheese-garlic-biscuits
...
scan_assets:
  - path: /scans/cheese-garlic-biscuits/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/cheese-garlic-biscuits/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/cheese-garlic-biscuits/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/cheese-garlic-biscuits/back-original.jpg
    label: Back scan
    type: image
    role: original
---
