...
scan_assets:
  - path: /scans/spaghetti-bake/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/spaghetti-bake/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/spaghetti-bake/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/spaghetti-bake/back-original.jpg
    label: Back scan
    type: image
    role: original
---
