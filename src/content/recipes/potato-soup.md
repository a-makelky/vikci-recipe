...
scan_assets:
  - path: /scans/potato-soup/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/potato-soup/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/potato-soup/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/potato-soup/back-original.jpg
    label: Back scan
    type: image
    role: original
---
