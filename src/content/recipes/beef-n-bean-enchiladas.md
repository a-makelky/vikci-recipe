---
id: scan-only-beef-n-bean-enchiladas
title: Beef 'n' Bean Enchiladas
...
scan_assets:
  - path: /scans/beef-n-bean-enchiladas/preview.jpg
    label: Preview
    type: image
    role: preview
  - path: /scans/beef-n-bean-enchiladas/original.jpg
    label: Scan
    type: image
    role: original
---
