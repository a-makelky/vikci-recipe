...
scan_assets:
  - path: /scans/2-hr-bread/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/2-hr-bread/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/2-hr-bread/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/2-hr-bread/back-original.jpg
    label: Back scan
    type: image
    role: original
---
