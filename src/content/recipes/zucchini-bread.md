...
scan_assets:
  - path: /scans/zucchini-bread/front-preview.jpg
    label: Front preview
    type: image
    role: preview
  - path: /scans/zucchini-bread/back-preview.jpg
    label: Back preview
    type: image
    role: preview
  - path: /scans/zucchini-bread/front-original.jpg
    label: Front scan
    type: image
    role: original
  - path: /scans/zucchini-bread/back-original.jpg
    label: Back scan
    type: image
    role: original
---
